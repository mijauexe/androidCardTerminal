...
object CameraUtils {
    ...
    private fun createCaptureSession() {
        try {
            captureRequestBuilder = cameraDevice?.createCaptureRequest(CameraDevice.TEMPLATE_STILL_CAPTURE)
                ?: throw IllegalStateException("Failed to create capture request.")
            ...
            Timber.d("Exception occurred while creating capture session: ${e.message}")
        }
    }
    ...
    private fun captureImage() {
        try {
            ...
            Timber.d("Exception occurred while capturing image: ${e.message}")
        }
    }
    ...
    private fun saveImage(image: Image?) {
        ...
        try {
            ...
            Timber.d("Exception occurred while saving image: ${e.message}")
        } finally {
            output?.close()
        }
    }
    ...
    private fun getCameraId(): String {
        try {
            ...
            Timber.d("Exception occurred while getting camera ID: ${e.message}")
        }
